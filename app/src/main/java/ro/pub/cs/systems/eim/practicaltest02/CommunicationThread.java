...
// PAS 4.1: Thread pentru gestionarea comunicatiei intre Client si Server
public class CommunicationThread extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            // In Client foloseam printWriter, in CommunicationThread folosesc bufferedReader: parametrii necesari pt furnizarea info
            ...
            // Obtinere referinta catre obiectul gestionat de Server -> HashMap
            ...
            if (data.containsKey(city)) {
                ...
                //HttpGet httpGet = new HttpGet(Constants.WEB_SERVICE_ADDRESS + "?q=" + city + "&APPID=" + Constants.WEB_SERVICE_API_KEY + "&units=" + "metric");
                ...
                for (int i = 0; i < weatherArray.length(); i++) {
                    ...
                    // Daca am mai multe elemente in Array -> despart prin ;
                ...
                // Creare obiect de tipul WeatherForecastInformation cu datele extrase din JSON
                // condition.toString() -> pt ca era StringBuilder
